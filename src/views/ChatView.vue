...
export default {
    ...
    async mounted() {
        try {
            const conversation = { conversationId: this.userId }
            const response = await axios
                .get(`http://localhost:5005/conversations/${this.userId}/tracker`)
    ...
    methods: {
        newConversation() {
            ...
            try {
                axios
                    .post(`${serverUrl}/users/${this.userId}/conversations`, newModel, {
                        headers: {
